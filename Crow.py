...
class Crow():
    def __init__(self, x_start, y_start, x_crop, y_crop, x_end, y_end):
        ...
        self.velocity = 1
        self.rest_timer = 0
        self.see_Distance = 20
        self.current_frame = 0

        self.phase = 0

        #loading the images
        image_filenames = ['crow1.png', 'crow2.png', 'crow3.png', 'crow4.png', 'crow5.png', 'crow6.png', 'crow7.png']
        self.images = [pygame.image.load("./assets/images/crow/" + filename) for filename in image_filenames]
    ...
    def draw(self, win):
        self.move()
        crow_rect = self.images[self.current_frame].get_rect(topleft = (self.x, self.y))
        win.blit(self.images[self.current_frame], crow_rect)
